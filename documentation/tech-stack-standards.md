...
Search online for the best Tailwind CSS configuration for the project.
...
We'll implement a simplified Prisma schema focusing on core User, Employee, Role, Department, and Project models with properly defined relationships and constraints.
